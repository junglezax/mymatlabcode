function pooledFeatures = cnnPool_par(poolDim, convolvedFeatures)
...
% -------------------- YOUR CODE HERE --------------------
	...
	pooledFeatures = reshape(pooledFeatures, [1, numFeatures, numImages, floor(convolvedDim / poolDim), floor(convolvedDim / poolDim)]);
end
